...
\begin{center}
  ...
  \end{tabular}
	\end{tabular}\\
  \vspace{0.6cm}
  \textit{\textbf{Tabela 5.1.4.1}. Wpływ gęstości siatki sztucznych wierzchołków dodanych do grafu na czas obliczeń}
\end{center}
...
\begin{center}
  ...
  \end{tabular}
	\end{tabular}\\
  \vspace{0.6cm}
  \textit{\textbf{Tabela 5.1.4.1}. Wpływ jakości wykrywania i eliminacji kolizji na czas obliczeń}
\end{center}
