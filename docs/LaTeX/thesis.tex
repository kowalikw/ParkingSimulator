...
Rozdziały czwarty i piąty szczegółowo opisują zasadę działania zaprojektowanych algorytmów planowania ruchu oraz automatycznego parkowania. Całość została przedstawiona w taki sposób, aby osoba czytająca niniejszą pracę była w stanie odtworzyć zaimplementowane w systemie algorytmy. 
